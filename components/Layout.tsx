...
export default function Layout({ children, title } : LayoutProps) {
    ...
    return (
        <div className=''>
            <Head>
                <title>{title || "Dapur Santai"}</title>
                    <meta name="title" content={title || "Dapur Santai"} />
                    <meta name="description" content={`Dapur Santai is a simple non-profit web application that helps with searching for Recipes/meals for personal needs or sharing them with others`} />
